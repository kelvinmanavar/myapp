pipeline {
    ...
    post {
        success {
            ...
            sshagent(credentials: ['aws-ec2']) {
                sh 'ssh -o StrictHostKeyChecking=no ubuntu@13.233.36.155 "unzip /home/ubuntu/artifact/artifact.zip -d /root"'
                sh 'ssh -o StrictHostKeyChecking=no ubuntu@13.233.36.155 "sudo mv /root/* /var/www/html"'
                script {
                    try {
